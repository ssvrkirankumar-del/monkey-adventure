...
public class HDSceneCyanDiagnostic : EditorWindow
{
    ...
    [MenuItem("Monkey Adventure/HD Scene Cyan Diagnostic")]
    public static void Open()
    {
        var window = GetWindow<HDSceneCyanDiagnostic>("HD Scene Cyan Diagnostic");
